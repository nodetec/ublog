<div class="HBLA_Details"><a href="#ArticleComments" style="text-decoration: unset;color: unset;">
        <div class="HBLA_Details_Card HBLA_D_CComments">
            <div class="HBLA_Details_CardVisual"><svg class="HBLA_Details_CardVisualIcon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
    ...
    <div id="reactBolt" class="HBLA_Details_Card HBLA_D_CBolt">
        <div class="HBLA_Details_CardVisual"><svg class="HBLA_Details_CardVisualIcon" xmlns="http://www.w3.org/2000/svg" viewBox="-64 0 512 512" width="1em" height="1em" fill="currentColor">
                <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
...
.HBLA_Details_Card:hover > .HBLA_Details_CardVisual > .HBLA_Details_CardVisualIcon {
  transition: ease 0.4s;
  transform: scale(1.1);
}

.HBLA_Details_Card:active > .HBLA_Details_CardVisual > .HBLA_Details_CardVisualIcon {
