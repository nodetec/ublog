  ...
  <div class="ContainerMain">
    <div class="HomeBody">
      <div class="HomeBodyList">
        <div class="HomeBodyListTitle">
          <h3 class="HomeBodyListTitleText">
            Search:<span class="HomeBodyListTitleTextSpan">Search term</span>
          </h3>
        </div>
...
<style>
  ...
  .HomeBodyListTitleText {
    display: flex;
    grid-gap: 5px;
  }

  .HomeBodyListTitleTextSpan {
    font-weight: normal;
  }
</style>
