<div class="HBSS_Author">
    <div class="HBSS_Author_Top">
            ...
            <div class="HBSS_Author_Top_Left_Inside">
                <div class="HBSS_Author_Top_Left_InsidePic">
                    <div class="HBSS_Author_Top_PPWrapper">
                        <div class="HBSS_Author_Top_PP" style="background: url('src/PPExamplePic.png') center / cover no-repeat;"></div>
                    </div>
                </div>
                <div class="HBSS_Author_Top_Left_InsideDetails">
                    <div class="HBSS_Author_TopWrapper">
                        <p class="HBSS_Author_Top_Name">Freakoverse</p>
                        <p class="HBSS_Author_Top_Handle">freakoverse@ublog.com</p>
                    </div>
                </div>
            </div>
            <div class="HBSS_Author_Top_AddressWrapper">
                <div class="HBSS_Author_Top_AddressWrapped">
                    <p id="SiteOwnerAddress" class="HBSS_Author_Top_Address">npub18n4ysp43ux5c98fs6h9c57qpr4p8r3j8f6e32v0vj8egzy878aqqyzzk9r</p>
                </div>
                <div class="HBSS_Author_Top_IconWrapper">
                    <div id="copySiteOwnerAddress" class="HBSS_Author_Top_IconWrapped"><svg class="HBSS_Author_Top_Icon" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" width="1em" height="1em" fill="currentColor">
                            <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                            <path d="M384 96L384 0h-112c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48H464c26.51 0 48-21.49 48-48V128h-95.1C398.4 128 384 113.6 384 96zM416 0v96h96L416 0zM192 352V128h-144c-26.51 0-48 21.49-48 48v288c0 26.51 21.49 48 48 48h192c26.51 0 48-21.49 48-48L288 416h-32C220.7 416 192 387.3 192 352z"></path>
                        </svg></div>
                    <div id="siteOwnerOpenPopUpMainQR" class="HBSS_Author_Top_IconWrapped"><svg class="HBSS_Author_Top_Icon" xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                            <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
                        ...
                        </svg></div><a class="HBSS_Author_Top_IconWrapped" href="https://primal.net/p/npub18n4ysp43ux5c98fs6h9c57qpr4p8r3j8f6e32v0vj8egzy878aqqyzzk9r" target="_blank"><svg class="HBSS_Author_Top_Icon" xmlns="http://www.w3.org/2000/svg" viewBox="-32 0 512 512" width="1em" height="1em" fill="currentColor">
                            <!--! Font Awesome Free 6.1.1 by @fontawesome - https://fontawesome.com License - https://fontawesome.com/license/free (Icons: CC BY 4.0, Fonts: SIL OFL 1.1, Code: MIT License) Copyright 2022 Fonticons, Inc. -->
        ...
        <div class="HBSS_Author_Top_Details">
            <p class="HBSS_Author_Top_Bio">I guess I&#39;m one of those #vtubers . Having fun talking about general topics, vrchat/similar, and games. Also #indiedev #gamedev You can call me: Freak فْرِيكٌ フリク (still learning Nihongo). #envtuber #podcast #gaming #gamedev</p>
            <div id="OwnerFollowLogin" class="HBSS_Author_Top_NostrLinks" style="display: flex;"><a id="followOwnerBtn" class="HBSS_Author_Top_NostrLinksLink HBSS_A_T_NLL_HBSSFollow" target="_blank">
...
.HBSS_Author_Top_QRCover:hover, focus, active {
  transition: ease 0.4s;
  background: #232323;
  display: flex;
  flex-direction: column;
